...
export const DEFAULT_SITE_CONFIG: SiteConfig = {
  ...
  galleryImages: [
    ...
    { id: 13, src: "/boda/optimized/gallery-13.jpg", alt: "Ailyn y Oswaldo" },
    { id: 14, src: "/boda/optimized/gallery-14.jpg", alt: "Momentos juntos" },
    { id: 15, src: "/boda/optimized/gallery-15.jpg", alt: "Nuestra historia" },
    { id: 16, src: "/boda/optimized/gallery-16.jpg", alt: "El compromiso" },
    { id: 17, src: "/boda/optimized/gallery-17.jpg", alt: "Celebrando el amor" },
    { id: 18, src: "/boda/optimized/gallery-18.jpg", alt: "Juntos para siempre" },
    { id: 19, src: "/boda/optimized/gallery-19.jpg", alt: "Nuestro camino" },
    { id: 20, src: "/boda/optimized/gallery-20.jpg", alt: "Recuerdos especiales" },
    { id: 21, src: "/boda/optimized/gallery-21.jpg", alt: "Amor eterno" },
    { id: 22, src: "/boda/optimized/gallery-22.jpg", alt: "Momentos únicos" },
    { id: 23, src: "/boda/optimized/gallery-23.jpg", alt: "Para siempre" },
  ],
  envelope: {
    enabled: true,
